...
func main() {
	...
	scene.Add(NewSphere(V(-0.75, 0.5, -1), 0.5, SpecularMaterial(HexColor(0xBEDB39), 1.3)))
	scene.Add(NewCube(V(-10, -1, -10), V(10, 0, 10), GlossyMaterial(Color{1, 1, 1}, 1.1, Radians(10))))
