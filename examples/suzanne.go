...
func main() {
	...
	scene.AddLight(pt.NewSphere(pt.Vector{0.5, 1, 3}, 0.5, pt.DiffuseMaterial(pt.Color{1, 1, 1}.MulScalar(60))))
	scene.AddLight(pt.NewSphere(pt.Vector{1.5, 1, 3}, 0.5, pt.DiffuseMaterial(pt.Color{1, 1, 1}.MulScalar(60))))
